...
void writeGtfsFiles(const std::string& gtfsDirectoryForDataSubset,
                    const std::vector<schedule::gtfs::Route>& routes,
                    const std::vector<schedule::gtfs::Trip>& trips,
                    const std::vector<schedule::gtfs::StopTime>& stopTimes,
                    const std::unordered_set<schedule::gtfs::Stop,
                                             decltype(schedule::gtfs::stopHash),
                                             decltype(schedule::gtfs::stopEqual)>& stops,
                    const std::vector<schedule::gtfs::Transfer>& transferItems,
                    const std::vector<schedule::gtfs::Calendar>& calendars,
                    const std::vector<schedule::gtfs::CalendarDate>& calendarDates)
{
