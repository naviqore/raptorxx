...
namespace raptor {
  ...
  private:
    ...
    void scanRoute(types::raptorIdx currentRouteIdx, types::raptorInt round, const std::unordered_set<types::raptorIdx>& markedStops, std::unordered_set<types::raptorIdx>& markedStopsNext) const;
